...
public:
     ...
     */
    Gist (int audioSampleSize, int numFFT, int numHop, int fs, WindowType windowType = HanningWindow);
     ...
     */
    void setAudioFrameSize (int audioFrameSize, int numFFT, int numHop);
	 ...
	 * @param frame a pointer to an array containing the audio frame
	 * @param numSamples the number of samples in the audio frame
	 * @param numFFT the number of FFT
	 * @param numHop the number of Hop
	 */
	void processSTFT(const T* frame, int numSamples, int numFFT, int numHop);
